...
const STEPS = [
  {
    ...
    description:
      "Explore 18+ AI capabilities available on the Livepeer network. Filter by category, status, and price. See managed solutions with SLA guarantees alongside raw network capabilities.",
    icon: Search,
  ...
  },
  {
    ...
    description:
      "Click any capability to open its detail page. Fill in the playground form and click Run to see a live inference result. Switch between Form, Python, Node.js, and cURL views.",
    icon: Play,
  ...
  },
  {
    ...
    description:
      "Copy the auto-generated code snippet from any capability's API tab. Paste it into your app, replace YOUR_API_KEY, and you're live. Supports cURL, Python, Node.js, and raw HTTP.",
    icon: Code,
    action: {
      label: "Read the Docs",
        ...
        <div className="mx-auto max-w-2xl px-5 py-12">
          ...
          <div className="mt-10 space-y-8">
            {STEPS.map((step) => (
              <div
                key={step.number}
                className="relative flex gap-5 rounded-xl border border-white/[0.06] bg-dark-surface p-6"
              >
                {/* Step number + icon */}
