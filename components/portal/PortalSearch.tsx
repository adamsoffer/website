...
const SUGGESTIONS: SearchResult[] = [
  { title: "Generate a video", subtitle: "Text-to-video and image-to-video on the network", href: "/portal/explore" },
  { title: "Explore capabilities", subtitle: "Browse capabilities available on the network", href: "/portal/explore" },
  { title: "Get your API key", subtitle: "Authenticate and start sending requests", href: "/portal/keys" },
  { title: "Transcode a stream", subtitle: "Live transcoding on GPU infrastructure", href: "/portal/models/livepeer-transcode" },
];
...
const ALL_RESULTS: SearchResult[] = [
  ...SUGGESTIONS,
  { title: "Daydream Video API", subtitle: "Real-time AI video generation", href: "/portal/models/daydream-video" },
  { title: "Livepeer Transcoding", subtitle: "Adaptive bitrate transcoding", href: "/portal/models/livepeer-transcode" },
  { title: "FLUX.1 [schnell]", subtitle: "Fast text-to-image generation", href: "/portal/models/flux-schnell" },
  { title: "SDXL Turbo", subtitle: "Real-time image generation", href: "/portal/models/sdxl-turbo" },
  { title: "Stable Video Diffusion", subtitle: "Image-to-video synthesis", href: "/portal/models/stable-video-diffusion" },
  { title: "LivePortrait", subtitle: "Real-time portrait animation", href: "/portal/models/live-video-to-video" },
  { title: "Qwen3 32B", subtitle: "Large language model", href: "/portal/models/qwen3-32b" },
  { title: "Llama 3 70B", subtitle: "Open LLM for chat and instructions", href: "/portal/models/llama-3-70b" },
  { title: "Whisper v3 Large", subtitle: "Speech-to-text transcription", href: "/portal/models/whisper-v3" },
  { title: "Kokoro TTS", subtitle: "Text-to-speech synthesis", href: "/portal/models/kokoro-tts" },
  { title: "Home", subtitle: "Portal overview", href: "/portal" },
  { title: "Billing", subtitle: "Manage billing and payments", href: "/portal/billing" },
  { title: "Settings", subtitle: "Account settings", href: "/portal/settings" },
];
...
export default function PortalSearch({ mobile = false }: PortalSearchProps = {}) {
        ...
        <div ref={listRef} className="max-h-[360px] overflow-y-auto py-3">
          ...
          {results.length === 0 ? (
            <div className="flex flex-col items-center justify-center gap-2 py-14 text-center">
              ...
              <Link href="/portal/explore" onClick={closeDialog} className="mt-1 text-xs text-green-bright/60 hover:text-green-bright transition-colors">
