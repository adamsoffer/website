...
export const LivepeerSymbol = forwardRef<SVGSVGElement, LogoProps>(
  function LivepeerSymbol({ className = "", style }, ref) {
    return (
      <svg
        ref={ref}
        viewBox="0 0 73 89"
        ...
        style={style}
      >
        <path d="M0 16.4436V0.944092H15.4995V16.4436H0Z" fill="currentColor" />
        <path
          d="M28.4692 34.504V19.0045H43.9687V34.504H28.4692Z"
          fill="currentColor"
        />
        <path
          d="M56.8936 52.5661V37.0667H72.393V52.5661H56.8936Z"
          fill="currentColor"
        />
        <path
          ...
          fill="currentColor"
        />
        <path d="M0 88.6207V73.1212H15.4995V88.6207H0Z" fill="currentColor" />
        <path d="M0 52.5661V37.0667H15.4995V52.5661H0Z" fill="currentColor" />
      </svg>
    );
  }
);
